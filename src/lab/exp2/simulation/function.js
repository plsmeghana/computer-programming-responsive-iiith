window.view = {
	...
	validateRightangleInputs: function() {
		...
		if ( a !== '2')
			alert('Incorrect value of input variables(arguments). Calculating the area of a rightangle requires the length of the two different parallel sides of the rightangle. Try again.')
		else if ( b !== 'float' )
			alert('Incorrect datatype of input variables(arguments). The value of the sides of a rightangle need not be integers. Try again.')
		else if ( c !== 'float' )
			alert('Incorrect datatype for return type. The value of the area of a rightangle need not be an integer. Try again.')
		else if ( d !== 'a*b' )
			alert('Incorrect formula for calculating the area of a rightangle. Try again.')
		else
	...
	displayFunctionForRightangle: function() {
		document.getElementById('functionRightangle').innerHTML += 'float area_right (float a,float b)<br>{<br> &emsp; float area = a*b;<br> &emsp; return area;<br>}'
	},
